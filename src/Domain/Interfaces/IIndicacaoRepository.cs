...
namespace Domain.Interfaces
{
    public interface IIndicacaoRepository
    {
        ...
        Task<Indicacao?> ObterPorIdAsync(
            Guid id,
        ...
        Task<IReadOnlyCollection<Indicacao>> ObterPorUsuarioIndicadorIdAsync(
            Guid usuarioIndicadorId,
            CancellationToken cancellationToken = default);

        Task<IReadOnlyCollection<Indicacao>> ObterPorStatusAsync(
